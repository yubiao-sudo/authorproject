...
from data.get_dataon import one
class Test_casePage:
    ...
    # baiduPage页面查询业务用例
    def test1_query(self,  pamr,pamr1, pamr2, NexList):
        obj = 'baidu_queryWorld'
        b = baiduPage(self.driver)
        b.qurey_world(pamr,pamr1)
        self.driver.implicitly_wait(10)
        t = b.assert_text(pamr).text
        time.sleep(2.5)
        b.get_windows_img(obj, pamr1)
        assert pamr2 in t, '测试不通过'
        self.driver.back()
